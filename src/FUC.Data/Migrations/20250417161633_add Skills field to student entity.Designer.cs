...
namespace FUC.Data.Migrations
{
    ...
    [Migration("20250417161633_add Skills field to student entity")]
    partial class addSkillsfieldtostudententity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FUC.Data.Entities.BusinessArea", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("243eb2aa-8a37-4cd3-a035-c8371937e6a4"));
            ...
            modelBuilder.Entity("FUC.Data.Entities.CoSupervisor", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("2597e9b6-37f8-4692-bd7e-166010c9fa9f"));
            ...
            modelBuilder.Entity("FUC.Data.Entities.Group", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("7dc829a3-6729-44aa-9b59-0dc509337aea"));
            ...
            modelBuilder.Entity("FUC.Data.Entities.GroupMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("02d197d5-ac76-4596-9de5-2c21caaebafa"));
            ...
            modelBuilder.Entity("FUC.Data.Entities.ReviewCalendar", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("31c09cd2-dbba-4182-95e1-001e85aff4ae"));
            ...
            modelBuilder.Entity("FUC.Data.Entities.ReviewCriteria", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("ce21b1ed-034c-4bf6-ab95-70ec17db7c77"));
            ...
            modelBuilder.Entity("FUC.Data.Entities.Reviewer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("d29a6721-8781-4f55-8f27-fd5db4ecd8c6"));
            ...
            modelBuilder.Entity("FUC.Data.Entities.TemplateDocument", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("a15a4c7c-61cd-4b2a-a40d-7f0bffc92d45"));
            ...
            modelBuilder.Entity("FUC.Data.Entities.Topic", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("e84b8854-d583-42c6-9f2e-0c6af918674e"));
            ...
            modelBuilder.Entity("FUC.Data.Entities.TopicAnalysis", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("fda38c0b-65d8-4c1e-8ecc-7a66b43a64ed"));
                    ...
                    b.Property<DateTime>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp")
                        .HasDefaultValue(new DateTime(2025, 4, 17, 23, 16, 32, 699, DateTimeKind.Local).AddTicks(4942));
            ...
            modelBuilder.Entity("FUC.Data.Entities.TopicAppraisal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("9bb9ced1-5c1a-4037-bf3e-6edf6307ed8b"));
            ...
            modelBuilder.Entity("FUC.Data.Entities.TopicRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("aa207ee7-62ae-41dc-8199-531680279f68"));
